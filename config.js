module.exports = {
	...
	adminId: "832500419551821865", //- Replace UserId with the Discord ID of the admin of the bot
	token: process.env.token || "OTYyMzM4NDQ1ODY1NDE4ODEy.GVSBDS.W7Ncvhc22T31tQW6EM55q4ILEmpxes5KS26j9A", //- Bot's Token
	clientId: process.env.clientId || "962338445865418812", //- ID of the bot
	clientSecret: process.env.clientSecret || "YkaiAZ22QXEh3bIes0jEVzqqv9mIiE4C", //- Client Secret of the bot
	...
	nodes: [
		{
			...
			host: "lavalink.michudumb.xyz", //- The host name or IP of the lavalink server.
			port: 2083, // The port that lavalink is listening to. This must be a number!
	...
	embedColor: "#2b2c30", //- Color of the embeds, hex supported
	presence: {
	...
	iconURL: "https://cdn.discordapp.com/attachments/961622755411918868/1212636010500849724/enlarged.gif?ex=65f28e4a&is=65e0194a&hm=7f885880d3204b4d0fbc5f6081dd105cdde42d0408ac70dd4e4625bcda74f315&", //- This icon will be in every embed's author field
};
